 ...
 */
public class TablaSimbolosfca extends ArrayList<Simbolofca>{
    TablaSimbolosfca padre; 
    
    public TablaSimbolosfca(TablaSimbolosfca padre) {
        super();
        this.padre = padre;
    }
    ...
    public void agregarVariable(Simbolofca var){
        this.add(var);
    }
